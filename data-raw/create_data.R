        ...
        tryCatch(
          {
            ...
            if (dataset_name == "adaeocmq") {
              ...
              roxygen2_data(
                dataset_name,
                custom_description = "adtte_onc modified from pharmaverseadam",
                custom_source = "data from adtte_onc from pharmaverseadam"
              )
            } else if (dataset_name == "adexsum") {
              roxygen2_data(
                dataset_name,
                custom_description = "adex modified from pharmaverseadam",
                custom_source = "data from adex from pharmaverseadam"
              )
            } else {
